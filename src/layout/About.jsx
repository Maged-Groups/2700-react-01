...
export default function About() {
    return (
        <section className='flex flex-col gap-8 md:flex-row justify-between lg:px-24 md:px-10 px-3 md:pt-10 mt-10'>
            <div data-aos="fade-up" className='grid gap-10 w-full md:w-8/12'>
                ...
                <div className='lg:flex grid sm:gap-0 gap-5 sm:justify-start sm:items-center'>
