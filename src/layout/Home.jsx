...
export default function Home() {
    ...
    return (
        <section className="lg:px-24 md:px-10 md:pt-10 bg-[#F2F9FF]">
            ...
            <nav className="flex fixed md:w-10/12 w-full opacity-95 top-1 md:top-10 justify-between items-center mb-10 shadow-lg px-5 rounded-2xl h-16 bg-white z-50">
            ...
            <div data-aos="fade-up" className="md:flex pt-24">
