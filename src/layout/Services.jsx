...
export default function Services() {
    return (
        <section className='bg-[#F3F9FF] py-10'>
            ...
            <div className='mt-10 lg:px-16 px-5 lg:flex justify-between flex-wrap grid gap-5'>
                <div data-aos='fade-up' className=' group/card lg:w-5/12 w-full  flex items-start justify-center gap-10 bg-white rounded-2xl p-5'>
                    <MdOutlineShowChart className='group-hover/card:bg-blue-600 group-hover/card:text-white xl:w-3/12 lg:w-5/12 md:w-3/12 w-6/12  h-16 p-2 bg-blue-200 rounded-xl text-blue-600 scale-80'/>
                ...
                <div data-aos='fade-up' className=' group/card lg:w-5/12 w-full  flex items-start justify-center gap-10 bg-white rounded-2xl p-5'>
                    <PiTreeStructureThin className='group-hover/card:bg-blue-600 group-hover/card:text-white xl:w-3/12 lg:w-5/12 md:w-3/12 w-6/12  h-16 p-2 bg-blue-200 rounded-xl text-blue-600 scale-80'/>
                    <div className='flex flex-col gap-5 items-start'>
                ...
                <div data-aos='fade-up' className=' group/card lg:w-5/12 w-full  flex items-start justify-center gap-10 bg-white rounded-2xl p-5'>
                    <AiOutlineFundProjectionScreen className='group-hover/card:bg-blue-600 group-hover/card:text-white xl:w-3/12 lg:w-5/12 md:w-3/12 w-6/12  h-16 p-2 bg-blue-200 rounded-xl text-blue-600 scale-80'/>
                    <div className='flex flex-col gap-5 items-start'>
                ...
                <div data-aos='fade-up' className=' group/card lg:w-5/12 w-full  flex items-start justify-center gap-10 bg-white rounded-2xl p-5'>
                    <BsClipboardData className='group-hover/card:bg-blue-600 group-hover/card:text-white xl:w-3/12 lg:w-5/12 md:w-3/12 w-6/12  h-16 p-2 bg-blue-200 rounded-xl text-blue-600 scale-80'/>
                    <div className='flex flex-col gap-5 items-start'>
